...
class Collator(object):
    ...
    def __call__(self, batch):
        ...
        for sample_i, sample in enumerate(batch):
            ...
            # wzy的添加
            batch_tail_label.append([sample['label'][-1]])
            batch_head_label.append([sample['label'][0]])
        ...
        # wzy的添加
        batch_multi_hot_tail_label = self._multi_hot(batch_tail_label)
        ...
        if self.mode == "TRAIN":
            ...
            return {
                ...
                'tail_label_list': batch_tail_label,
                'tail_label': batch_multi_hot_tail_label,
                'head_label_list': batch_head_label
            }
        else:
            return {
                'token': batch_token,
